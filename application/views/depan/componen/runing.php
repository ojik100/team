                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
								...
								<li><marquee behavior="" direction="">
								<?php foreach($harga as $h):?>
									<b style="color:green"><?= $h->keterangan.$h->harga?> || </b>
								<?php endforeach;?>
								</marquee></li>
                            </ul>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        ...
                        <a href="<?= base_url('home')?>"><img height="50px" width="80px" src="<?= base_url('assets/')?>lades.png" alt=""></a>
